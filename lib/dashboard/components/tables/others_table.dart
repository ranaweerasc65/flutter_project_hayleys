...
class OthersTable extends StatefulWidget {
  ...
  final Function onOtherAdded;
  final int? illnessId;

  const OthersTable({
    super.key,
    required this.customerId,
    required this.onOtherAdded,
    this.illnessId,
  });
...
class _PrescriptionsTableState extends State<OthersTable> {
          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                opacity: 0.1,
                image: AssetImage("assets/prescription_background.jpg"),
